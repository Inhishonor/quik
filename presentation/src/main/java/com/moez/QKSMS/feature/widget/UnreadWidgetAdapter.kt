...
class UnreadWidgetAdapter(intent: Intent) : RemoteViewsService.RemoteViewsFactory {
    ...
    override fun onDataSetChanged() {
        conversations = conversationRepo.getAllUnreadConversationsSnapshot()
    ...
    private fun getConversationView(position: Int): RemoteViews {
        ...
        remoteViews.setOnClickFillInIntent(
            R.id.conversation,
            Intent()
                .putExtra("activityToStart", StartActivityFromWidgetReceiver.Companion.COMPOSE_ACTIVITY)
    ...
    private fun getOverflowView(): RemoteViews {
        ...
        view.setOnClickFillInIntent(
            R.id.loadingText,
            Intent()
                .putExtra("activityToStart", StartActivityFromWidgetReceiver.Companion.MAIN_ACTIVITY)
        )
        return view
    }
